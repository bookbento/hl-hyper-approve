...
export type PdfOverlayAttachedProps = {
...
const PdfOverlayAttached: React.FC<PdfOverlayAttachedProps> = ({
  src,
  downloadUrl,
  onClose,
  canTerminate,
        ...
        >
          ...
          <button
            ...
            className="
              ...
              px-4 py-1.5 rounded bg-emerald-600 hover:bg-emerald-700
...
export default React.memo(PdfOverlayAttached);
